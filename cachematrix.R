...
makeCacheMatrix <- function(x = matrix()) {                        ## Returns a list of objects of class function that set and retrieve the matrix as well as its inverse. 
                                                                                      ## 'x' is the matrix object to be passed to the function. 'inverse' is the cache used to store the inverse of x.
        inverse <- matrix(,0,0)                                                 ##The cache is empty(set to a 0X0 matrix) by default
